  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        ...
        "$mod, 1, workspace, 〇"  "$mod SHIFT, 1, movetoworkspace, 〇" 
        "$mod, 2, workspace, 一"  "$mod SHIFT, 2, movetoworkspace, 一"
        "$mod, 3, workspace, 二"  "$mod SHIFT, 3, movetoworkspace, 二"
        "$mod, 4, workspace, 三"  "$mod SHIFT, 4, movetoworkspace, 三"
        "$mod, 5, workspace, 四"  "$mod SHIFT, 5, movetoworkspace, 四"
        "$mod, 6, workspace, 五"  "$mod SHIFT, 6, movetoworkspace, 五"
        "$mod, 7, workspace, 六"  "$mod SHIFT, 7, movetoworkspace, 六"
        "$mod, 8, workspace, 七"  "$mod SHIFT, 8, movetoworkspace, 七"
        "$mod, 9, workspace, 八"  "$mod SHIFT, 9, movetoworkspace, 八"
        "$mod, 0, workspace, 九"  "$mod SHIFT, 0, movetoworkspace, 九"
